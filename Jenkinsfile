node
 {
  ...
  def mvnHome = tool name: "Maven3.6.4"
  ...
  {
   git branch: 'development', credentialsId: '65fb834f-a83b-4fe7-8e11-686245c47a65', url: 'https://github.com/Tesman22/maven-web-application.git'
 }
